...
molfile_plugin_t dcd_plugin = {
    vmdplugin_ABIVERSION,               // ABI version
    MOLFILE_PLUGIN_TYPE,                // type of plugin
    "dcd",                              // short name of plugin
    "CHARMM,NAMD,XPLOR DCD Trajectory",                  // pretty name of plugin
    "Axel Kohlmeyer, Justin Gullingsrud, John Stone", // authors
    1,       // major version
    11,       // minor version
