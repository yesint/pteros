...
void Consumer::pre_process(){
}

bool Consumer::process_frame(const Frame_info& info){
    return true;
}

void Consumer::post_process(const Frame_info& info){
}

void Consumer::window_started(const Frame_info& info){
}

void Consumer::setup(){
}

void Consumer::before_each_frame(){
}


void Consumer::window_finished(const Frame_info& info){
}


void Consumer::process_frame_info(Frame_info& info){
