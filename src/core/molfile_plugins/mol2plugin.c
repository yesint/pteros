...
molfile_plugin_t mol2_plugin = {
    vmdplugin_ABIVERSION,               // ABI version
    MOLFILE_PLUGIN_TYPE,                // type of plugin
    "mol2",                              // short name of plugin
    "MDL mol2",                      // pretty name of plugin
    "Peter Freddolino, Eamon Caddigan", // authors
    0,       // major version
    16,       // minor version
    VMDPLUGIN_THREADUNSAFE,             // is not reentrant
    "mol2",                              // filename extension
    open_mol2_read,
    read_mol2,
    read_mol2_bonds,
    read_mol2_timestep,
    close_mol2_read,
    open_mol2_write,                                  // open_write
    write_mol2_structure,                                  // write_structure
    write_mol2_timestep,                                  // write_timestep
    close_mol2_write,                                  // close_write
