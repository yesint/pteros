...
void make_bindings_Periodic_box(py::module& m){
    ...
    py::class_<Periodic_box>(m, "Periodic_box")
        ...
        .def("distance",&Periodic_box::distance, "point1"_a, "point2"_a, "pbc"_a=Eigen::Vector3i::Ones())
        .def("distance_squared",&Periodic_box::distance_squared, "point1"_a, "point2"_a, "pbc"_a=Eigen::Vector3i::Ones())
        .def("wrap_point",&Periodic_box::wrap_point, "point"_a, "pbc"_a=Eigen::Vector3i::Ones())
        .def("in_box",&Periodic_box::in_box, "point"_a, "origin"_a=Eigen::Vector3i::Zero())
        .def("get_closest_image",&Periodic_box::get_closest_image, "point"_a, "target"_a, "pbc"_a=Eigen::Vector3i::Ones())
        .def("shortest_vector",&Periodic_box::shortest_vector, "point1"_a, "point2"_a, "pbc"_a=Eigen::Vector3i::Ones())
